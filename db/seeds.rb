...
Chair.create!([
	{id: 1,
		...
		remote_img_url:"https://i.ibb.co/FDHbL47/ghe-lung-trung-sl606-removebg-preview.png",
	...
	{id: 2,
		...
		category_id: 1,
		function: "Office chair",
		remote_img_url:"https://i.ibb.co/HNtzPZT/GL401-removebg-preview.png",
...
Sponge pads covered with porous mesh fabric, armrest, leather seats.",
	...
	{id: 3,
		...
		category_id: 1,
		function: "Office chair",
		remote_img_url:"https://i.ibb.co/T1m8Bkz/GL403-removebg-preview.png",
...
The armrests use shiny Ni-Cr plated steel create elegance.",
	...
	{id: 4,
		...
		category_id: 1,
		function: "Office chair",
		remote_img_url:"https://i.ibb.co/3SSsMsm/gl407-removebg-preview.png",
...
Mesh seat cushion is porous.",
	...
	{id: 5,
		...
		category_id: 1,
		function: "Office chair",
		remote_img_url:"https://i.ibb.co/p1hKqd6/gl406-removebg-preview.png",
	...
	{id: 6,
		...
		category_id: 1,
		function: "Office chair",
		remote_img_url:"https://i.ibb.co/R3rbYJL/ghe-luoi-gl412m-removebg-preview.png",
...
With outstanding advantages: the chair is very smooth and airy, creating a pleasant feeling for users. The chair is suitable for use by office workers or for families.",
	...
	{id: 7,
		...
		category_id: 1,
		function: "Cafe chair",
		remote_img_url:"https://i.ibb.co/GtBPYS8/ghe-cafe-G31-1-removebg-preview.png",
...
The product can be used in sync with a coffee table to create a complete cafe tables and chairs.",
	...
	{id: 8,
		...
		category_id: 1,
		function: "Cafe chair",
		remote_img_url:"https://i.ibb.co/GRsDnDN/ghe-g32-removebg-preview.png",
...
The product can be used in sync with a coffee table to create a complete cafe tables and chairs.",
	...
	{id: 9,
		...
		remote_img_url:"https://i.ibb.co/mB9fMv2/ghe-xoay-van-phong-hoa-phat-sg1020-removebg-preview.png",
...
Plastic feet with wheels, plastic hands, bowls with the function of adjusting the height of the chair and slightly reclining chair.",
	...
	{id: 10,
		...
		category_id: 1,
		function: "Manager chair",
		remote_img_url:"https://i.ibb.co/qJLCDxC/SG920-removebg-preview.png",
...
The chair has a reclining mechanism and a leg resting mechanism relaxes",
	...
	{id: 11,
		...
		category_id: 1,
		function: "Bar chair",
		remote_img_url:"https://i.ibb.co/MG0FkZw/SB01-removebg-preview.png",
...
Galvanized bar seats, PVC-covered foam cushions, height-adjustable seats with leg room",
	...
	{id: 12,
		...
		category_id: 1,
		function: "Bar chair",
		remote_img_url:"https://i.ibb.co/cT5gXck/SB03-removebg-preview.png",
	...
	{id: 13,
		...
		remote_img_url:"https://i.ibb.co/w4S5tx0/GNB3-removebg-preview.png",
...
The oval cushion surface helps pregnant women lie comfortably. Length adjustable foot mats.",
	...
	{id: 14,
		...
		category_id: 1,
		function: "Office sleeping chair",
		remote_img_url:"https://i.ibb.co/RNWCtdQ/GN02-removebg-preview.png",
		description:"Xuan Phat office sleeping chair is designed for pregnant women when they want to take a nap at the office.
The oval cushion surface helps pregnant women lie comfortably. Length adjustable foot mats.",
		price: 643,
		quantity: 20
	...
	{id: 15,
		...
		category_id: 1,
		function: "Office sleeping chair",
		remote_img_url:"https://i.ibb.co/JtkshcV/GNS2-Den1-510x510-removebg-preview.png",
		description:"Xuan Phat office sleeping chair is designed for pregnant women when they want to take a nap at the office.
The oval cushion surface helps pregnant women lie comfortably. Length adjustable foot mats.",
		price: 1268,
		quantity: 20
	...
	{id: 16,
		...
		category_id: 1,
		function: "office chair",
		remote_img_url:"https://i.ibb.co/MGS6kTL/C135-A-removebg-preview.png",
...
Brackets Ø19.1mm steel, painted silver.",
	...
	{id: 17,
		...
		category_id: 1,
		function: "office chair",
		remote_img_url:"https://i.ibb.co/THNK6C8/G03-A-removebg-preview.png",
...
G03A folding chairs are folding chairs, Ø22 steel pipe frames, PVC-covered foam pads and felts commonly used in the dining room or lounge.",
	...
	{id: 18,
		...
		category_id: 1,
		function: "office chair",
		remote_img_url:"https://i.ibb.co/K7VsRyQ/ghe-phong-hop-SL711-removebg-preview.png",
	...
	{id: 19,
		...
		category_id: 1,
		function: "office chair",
		remote_img_url:"https://i.ibb.co/5srWQ1K/HS712-HS-removebg-preview.png",
		description:"Chair legs are kneeling with black powder coated steel pipes, the seats are made of cheese, the foam padding is covered with felt cloth, plastic hands.",
		price: 708,
		quantity: 20
	},
	...
	{id:20,
		...
		category_id: 1,
		function: "office chair",
		remote_img_url:"https://i.ibb.co/zhY7s25/ghe-phong-hop-SL719-removebg-preview.png",
		description:"Chair legs are kneeling with black powder coated steel pipes, the seats are made of cheese, the foam padding is covered with felt cloth, plastic hands.",
		price: 884,
		quantity: 20
	},
...
Transport chair with powder coated aluminum ultralight frame is durable and has a weight capacity of 300 lbs",
	...
	{id: 22,
		...
		category_id: 2,
		function: "Wheelchair",
		remote_img_url:"https://i.ibb.co/NYF7rX1/81e-QI5a-NIBL-removebg-preview.png",
...
Premium welds ensure reliability and durability",
	...
	{id: 24,
		...
		category_id: 2,
		function: "Wheelchair",
		remote_img_url:"https://i.imgur.com/P9SOBuY.png",
...
FOLDING COMPACT DESIGN - WISGING D09 Electric Wheelchair easy to fold design reduces The Travel Buggy in seconds to a compact unit about the size of a suitcase for storage or travel. Includes a black travel bag, making transporting even easier and convenient.",
	...
	{id: 25,
		...
		category_id: 2,
		function: "Wheelchair",
		remote_img_url:"https://i.ibb.co/qWkvm2t/613y-Lw-OPej-L-removebg-preview.png",
